...
# Plotting the heatmap without axis lines/text and with top 3 borough labels
ggplot(data = montreal_n_sum) +
  geom_sf(aes(fill = somme), color = "black") + # Use 'somme' for the fill, no border color
  scale_fill_gradient(low = "lightblue", high = "red",
                      na.value = "white", name = "Accident Sum") +
  labs(title = "Heatmap of Accident Sums by Borough",
       subtitle = "Montreal",
       x = "", y = "") +
  theme_minimal() +
